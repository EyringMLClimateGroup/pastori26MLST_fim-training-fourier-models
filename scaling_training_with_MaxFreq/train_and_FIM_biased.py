"""Scaling of training performance and effective dimension with MaxFreq (biased data generation).
...
For each of `no_rand_model_tests` random draws of (U, V, params0) at a given MaxFreq value, this
...
Other key control parameters (see 'Experiments specs' section below):
    no_rand_model_tests -- number of random (U, V, params0) model draws per MaxFreq value
